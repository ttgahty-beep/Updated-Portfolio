...
const CELL_SIZE = 55; // Grid cell size
const INFLUENCE_RADIUS = 260;
const MAX_WARP = 24;
const DOT_SPACING = 28;
const LERP_SPEED = 0.08;

const LINE_BASE = { r: 180, g: 200, b: 185, a: 0.15 };
...
export default function KineticGrid({
  ...
  children?: ReactNode;
  className?: string;
  globalColor?: "default" | "monochrome" | "kodama";
}) {
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = {
        kodama: {
          bg: "#0f1812",
          lineActive: { r: 66, g: 146, b: 103, a: 0.9 },
          nodeActive: { r: 66, g: 146, b: 103, a: 1.0 },
          glow: "66,146,103",
          ripple: "90,190,130",
          dot: "rgba(180, 210, 190, 0.08)",
        },
        default: {
          bg: "#161618",
      ...
      // Static background dot texture - optimized with fillRect instead of costly arc paths
